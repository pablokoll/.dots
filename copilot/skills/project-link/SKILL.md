...
3. Check if already linked — if `<repo>/.github/project-link.md` or `repo:` in frontmatter exist, warn and ask to overwrite
4. Create `<repo>/.github/project-link.md`:
...
- Create `<repo>/.github/` if it doesn't exist
